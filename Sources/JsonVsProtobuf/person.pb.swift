...
// Source: Sources/JsonVsProtobuf/Resources/person.proto
//
...
extension Person: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage(decoder: inout some SwiftProtobuf.Decoder) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try try decoder.decodeSingularInt32Field(value: &id)
            case 2: try try decoder.decodeSingularStringField(value: &name)
            case 3: try try decoder.decodeSingularInt32Field(value: &age)
            default: break
            }
        }
    }
    ...
    func traverse(visitor: inout some SwiftProtobuf.Visitor) throws {
        ...
        if age != 0 {
            try visitor.visitSingularInt32Field(value: age, fieldNumber: 3)
        }
